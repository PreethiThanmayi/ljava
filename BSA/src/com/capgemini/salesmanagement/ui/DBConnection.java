...
public class DBConnection {
	...
	private DBConnection() throws ProductException {
		try {
 ...
 */
	...
	public static Connection getConnection() throws ProductException , SQLException{
		if(connection==null){
			getInstance();
	...
	public static DBConnection getInstance() throws ProductException  {
